...
class P3RHeadGateModel(nn.Module):
    def __init__(self, model_name="microsoft/unixcoder-base", num_prompts=4, prompt_length=8):
        super().__init__()
        ...
        self.pre_trained_classifier = CompactSymbolicClassifier(self.embed_dim, 2)
    ...
    def forward(self, chunks, full_code, attention_mask):
        ...
        logits = self.pre_trained_classifier(cls_embedding)
        return logits
